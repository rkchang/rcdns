...
ABSL_FLAG(Ipv4Address, ns_addr, Ipv4Address("198.41.0.4"), "What nameserver to use");
...
int main(int argc, char *argv[]) {
  ...
  LOG(INFO) << "Starting server with port: " << port << " address: " << address << " ns_address: " << ns_address;
  asio::io_context io;
